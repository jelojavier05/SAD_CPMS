...
<div class="row"> 
    ...
    <div class="row">
     ...
     <div class="col s5 push-s3" style="margin-left:-2%">
                   ...
                   <h3 class="blue-text animated fadeIn" style="font-family:Myriad Pro;margin-top:9.2%">Government Exam</h3>
                </div>
    ...
    <div class="col s12 push-s1" style="margin-top:-4%">
        <div class="container blue-grey lighten-4 z-depth-2 animated fadeIn" style="padding-left:2%; padding-right:2%;">
            <div class="row">
                ...
                <div class="col s3">
                    <button style="margin-top: 20px;" id="btnAdd" class=" z-depth-1 btn-large green modal-trigger" href="#modalgovexamAdd">
...
<div id="modalgovexamAdd" class="modal modal-fixed-footer ci" style="overflow:hidden; width:40% !important; margin-top:100px !important;  max-height:100% !important; height:250px !important; border-radius:10px;">
...
<!-- MODAL govexam EDIT -->
<div id="modalgovexamEdit" class="modal modal-fixed-footer ci" style="overflow:hidden; width:40% !important; margin-top:100px !important;  max-height:100% !important; height:300px !important; border-radius:10px;">
	<div class="modal-header">
                <div class="h">
                    <h3><center>Government Exam</center></h3>  
				</div>
