  ...
  <div class="row"> 
    ...
    <div class="row">
     ...
     <div class="col s5 push-s3" style="margin-left:-2%">
                   ...
                   <h3 class="blue-text animated fadeIn" style="font-family:Myriad Pro;margin-top:9.2%">City</h3>
                </div>
    ...
    <div class="col s12 push-s1" style="margin-top:-4%">
        <div class="container blue-grey lighten-4 z-depth-2 animated fadeIn" style="padding-left:2%; padding-right:2%;">
            <div class="row">
                ...
                <div class="col s3">
                    <button style="margin-top: 20px;" id="btnAdd" class=" z-depth-1 btn-large green modal-trigger" href="#modalcityAdd">
                    ...
                    <table class="striped white" style="border-radius:10px;" id="dataTable">
                        <thead>
                            <tr>
                                ...
                                <th class="blue darken-3 white-text">Province</th>
                                <th class="blue darken-3 white-text">City</th>
                            </tr>
                        </thead>
