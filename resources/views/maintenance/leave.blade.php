	...
	<!-- ADD EDIT DELETE BUTTON-->
		<div class="row">
			<div class="col s12">	
				...
				<div class="col s3 offset-s3">
					<button style="margin-top: 60px;" id="btnAdd" class="z-depth-2 btn-large waves-effect waves-light green hide-on-med-and-down modal-trigger" href="#modalleaveAdd"><i class="material-icons">add</i> ADD</button></br></br>
				</div>
           ...
           <tbody>
				...
				<div class="row">
					<div class="col s3 push-s4">
						<div class="white" style="position:absolute; margin-top:-115px;">{!! $leaves->render() !!}</div>
				</div></div></div>
