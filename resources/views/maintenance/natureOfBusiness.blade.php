	...
	<div class="row">
        <div class="col s12">
            ...
            <div class="col s3 push-s4">
                <button style="margin-top: 30px;" id="btnAdd" class=" z-depth-2 btn-large waves-effect waves-light green hide-on-med-and-down modal-trigger" href="#modalnobAdd">
                        ...
                        <tbody>
                            @foreach ($natureOfBusinesses as $natureOfBusiness)
                                <tr>
                                    ...
                                    <td>
                                        <button class="buttonUpdate btn modal-trigger"  name="" id="{{ $natureOfBusiness->intNatureOfBusinessID }}" href="#modalnobEdit" style="margin-right:-20px;">
                                    ...
                                    <td>
                                        <button class="buttonDelete btn red" style="margin-left:-100px;" id="{{ $natureOfBusiness->intNatureOfBusinessID }}">
                                            <i class="material-icons">delete</i>
                                        </button>
                                    </td>

                                    <td id = "id{{$natureOfBusiness->intNatureOfBusinessID}}">
                                        {{ $natureOfBusiness->intNatureOfBusinessID }}
                                    </td>
                                    
                                    <td id = "name{{$natureOfBusiness->intNatureOfBusinessID}}">
