...
@section('content')
   ...
   <div class="row">
         <div class="col s5 push-s3" style="margin-left:-5%;margin-top:-1.5%">
                <h3 style="font-family:Myriad Pro;margin-top:9.2%;color:#2D4262">Request for <i>GUNS</i></h3>
         </div>
    </div>
<!-------------------------TABS----------------------->
              ...
              <div class="card white-content" style="border: 1px solid grey;">
                  <div class="card-content" style="background-color:#F0EFEA">
                         ...
                         <!--<span class="card-title"><center>Request for <b>Additional Guns</b></center></span>-->
                          <p>Requisition of <strong>additional guns</strong> for better maintenance of services.</p>


                              <div class="input-field col s3 offset-s10 pull-s10">
                                  <i class="material-icons prefix">toc</i>
                                  <input id="icon_prefix" type="number" class="validate" value="1">
                                  <label for="icon_prefix">Gun Needed</label>
                              </div>
     ...
     <div id="test2" class="col s10 push-s2" style="margin-left:1.2%">
              <div class="card white-content" style="border: 1px solid grey;">
                  <div class="card-content" style="background-color:#F0EFEA">
                         ...
                         <!-- <span class="card-title"><center>Request for <b>Gun Replacement</b></center></span>-->
                          <p>Requisition of <strong>replacing guns</strong> for better maintenance of services.</p>
